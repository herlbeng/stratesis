...
Route::resource('proyectos/proyectos', 'Proyectos\\ProyectosController');
Route::resource('proyectos/proyectos', 'Proyectos\\ProyectosController');
Route::resource('pagos/pagos', 'Pagos\\PagosController');
Route::resource('pagos/pagos', 'Pagos\\PagosController');
Route::resource('bancos/bancos', 'Bancos\\BancosController');
Route::resource('pagos/pagos', 'Pagos\\PagosController');
Route::resource('pagos/pagos', 'Pagos\\PagosController');
Route::resource('pagos/pagos', 'Pagos\\PagosController');
Route::resource('pagos/pagos', 'Pagos\\PagosController');
Route::resource('evaluaciones/evaluaciones', 'Evaluaciones\\EvaluacionesController');