...
<!-------------- Settings  menu --------------->
   ...
   @if (Auth::user()->hasRole('Admin'))
			 <li class="site-menu-item has-sub {{ Request::is('settings') ? 'active open' : '' }}">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item {{ Request::is('settings') ? 'active' : '' }}">
                  <a class="animsition-link" href="{{URL::to('/bancos/bancos')}}">
  ...
  <li class="site-menu-item has-sub {{ Request::is('settings') ? 'active open' : '' }}">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item {{ Request::is('settings') ? 'active' : '' }}">
                  <a class="animsition-link" href="{{URL::to('/proyectos/proyectos')}}">
  ...
  <li class="site-menu-item has-sub {{ Request::is('settings') ? 'active open' : '' }}">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item {{ Request::is('settings') ? 'active' : '' }}">
                  <a class="animsition-link" href="{{URL::to('/pagos/pagos')}}">
